# P05 checks: Allocate Functions Across Hardware and Software
...
- the learner can answer: “What inputs, observable effects, and failure modes matter when you allocate Functions Across Hardware and Software?” without relying on MATLAB syntax.
