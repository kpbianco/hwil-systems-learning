# P20 checks: Control Configuration and Calibration State
...
- the learner can answer: “What inputs, observable effects, and failure modes matter when you control Configuration and Calibration State?” without relying on MATLAB syntax.
