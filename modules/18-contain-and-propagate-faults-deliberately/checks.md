# P18 checks: Contain and Propagate Faults Deliberately
...
- the learner can answer: “What inputs, observable effects, and failure modes matter when you contain and Propagate Faults Deliberately?” without relying on MATLAB syntax.
