# P08 checks: Write an Interface Control Contract
...
- the learner can answer: “What inputs, observable effects, and failure modes matter when you write an Interface Control Contract?” without relying on MATLAB syntax.
