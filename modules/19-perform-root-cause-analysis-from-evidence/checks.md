# P19 checks: Perform Root-Cause Analysis from Evidence
...
- the learner can answer: “What inputs, observable effects, and failure modes matter when you perform Root-Cause Analysis from Evidence?” without relying on MATLAB syntax.
